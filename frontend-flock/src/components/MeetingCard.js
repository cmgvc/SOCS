...
const MeetingCard = ({ meeting }) => {
    ...
    const { title, date, time, faculty: organizer, duration, meetingType, _id: meetingId, status } = meeting;
        ...
        <div className="meeting-card">
            ...
            {!isPastOrStarted && status === 'Pending' && (
                <div className="pending-actions">
                    <button className="cancel-btn" onClick={() => handleUpdateMeetingStatus('Accepted')}>
                        Accept
                    </button>
                    &nbsp;&nbsp;&nbsp;
                    <button className="cancel-btn" onClick={() => handleUpdateMeetingStatus('Declined')}>
                        Decline
                    </button>
                </div>
            )}
